; (function ($, window, document, undefined) {
    ...
    $.fn[Plugin.globals.pluginName] = function (options) {
        ...
        this.each(function () {
            ...
            //}
            $(this).data("plugin_" + Plugin.globals.pluginName, window.Plugin.init(this, options));
            //if (!$(window).data("plugin_" + Plugin.globals.pluginName)) {
            //    $(window).data("plugin_" + Plugin.globals.pluginName, "set");
            //    $(this).data("plugin_" + Plugin.globals.pluginName, window.Plugin.init(this, options));
            //} else if (!$(this).data("plugin_" + Plugin.globals.pluginName)) {
            //    $(this).data("plugin_" + Plugin.globals.pluginName, window.Plugin.addElements(this, options));
            //}
        });
